...
export default function HeroSection({ profileImage, compressedProfileImage, quote }: HeroSectionProps) {
  ...
  return (
    <section
      id='home'
      className='relative flex justify-center bg-black text-white h-screen min-h-[720px] pt-20 overflow-hidden'
    >
      {/* Matrix Background */}
      <MatrixBackground />
      ...
      <div className='relative z-10 mx-10 py-20 sm:py-12 h-[80vh] min-h-[720px] w-full flex justify-left gap-20 items-center max-w-[1024px] max-sm:flex-col-reverse max-sm:space-y-20 max-sm:pb-16'>
        ...
        >
          <div className='relative'>
            <Image
              ...
              width={400}
              height={400}
              className='relative w-[400px] max-sm:w-[300px] select-none pointer-events-none rounded-full shadow-lg hover:scale-110 transition duration-300 ease-in-out'
              priority={true}
              placeholder='blur'
